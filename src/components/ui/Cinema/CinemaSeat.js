...
class CinemaSeat extends Component {
 ...
 render () {
  return (
   <div className={this.state.selected ? "cinema__app__seat--selected" : "cinema__app__seat"} letter={this.state.rowLetters[this.props.row]} onClick={this.toggleActive.bind(this)}>
